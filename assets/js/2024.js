const rejectMessages = [
  ...
  <p class="pt-2">Bạn thật tài giỏi, thà nghèo khổ, chứ không nhận lì xì!</p>`,
  //
  `<div class="flex flex-col sm:flex-row items-center">
    <div class="w-[60%] lg:w-[10vw] md:w-[20vw] m-4">
      <img style="width:100px;height:100px" src="../assets/images/qr-code-latienanh.png" />
    </div>
    <div class="flex flex-col">
      <p class="pt-2">Nếu bạn đã nhất quyết từ chối như vậy!</p>
      <p class="pt-2">Vậy lì xì lại cho Tiến Anh nhé =))</p>
    </div>
  </div>`,
];
